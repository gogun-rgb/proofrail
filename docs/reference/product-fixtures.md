...
| `evidence-gate.cli-output-adversarial.v1` | adversarial | `evidence-gate.static-cli` | @proofrail/evidence-gate#bin:evidence-gate | Exercises inert instruction-shaped and synthetic secret-shaped content through runner-controlled staged output. |
| `evidence-gate.cli-output-malformed.v1` | malformed | `evidence-gate.static-cli` | @proofrail/evidence-gate#bin:evidence-gate | Proves malformed JSON creates no staged output and keeps stdout empty. |
| `evidence-gate.cli-output-negative.v1` | negative | `evidence-gate.static-cli` | @proofrail/evidence-gate#bin:evidence-gate | Proves rejected packet input creates no staged output and keeps stdout empty. |
| `evidence-gate.cli-output-positive.v1` | positive | `evidence-gate.static-cli` | @proofrail/evidence-gate#bin:evidence-gate | Binds staged output bytes and empty stdout; the runner owns and removes the output path. |
...
| `static-evaluator.output-adversarial.v1` | adversarial | `static-evaluator.cli` | @proofrail/static-evaluator#bin:static-evaluate | Proves oversized input creates no staged output and keeps stdout empty. |
| `static-evaluator.output-malformed.v1` | malformed | `static-evaluator.cli` | @proofrail/static-evaluator#bin:static-evaluate | Proves invalid UTF-8 creates no staged output and keeps stdout empty. |
| `static-evaluator.output-negative.v1` | negative | `static-evaluator.cli` | @proofrail/static-evaluator#bin:static-evaluate | Binds a deterministic non-admissible staged bundle and empty stdout. |
| `static-evaluator.output-positive.v1` | positive | `static-evaluator.cli` | @proofrail/static-evaluator#bin:static-evaluate | Binds staged output bytes and empty stdout; the runner owns and removes the output path. |
...
| `static-evaluator.positive.v1` | positive | `static-evaluator.cli` | @proofrail/static-evaluator#bin:static-evaluate | Exercises stdout delivery; runner-controlled staged output is covered separately. |
...
| `trusted-config.loader-malformed.v1` | malformed | `trusted-config.load` | @proofrail/trusted-config#export:. | Replaces only a temporary copy of the trusted configuration with malformed JSON. |
...
| `trusted-config.strict-json-adversarial.v1` | adversarial | `trusted-config.strict-json` | @proofrail/trusted-config#export:. | Exercises inert instruction-shaped and synthetic secret-shaped strings through strict JSON parsing. |
...
| `trusted-config.strict-json-negative.v1` | negative | `trusted-config.strict-json` | @proofrail/trusted-config#export:. | Exercises deterministic rejection of a non-string parser input, distinct from malformed JSON text. |
...
| --- | --- | --- | --- | --- |
| `@proofrail/contracts#export:.` | `contracts.constants` | `contract-constants` | `contracts.constants.v1` | positive; No-input constant export; negative, malformed, and adversarial fixture classes are inapplicable. |
| `@proofrail/evidence-gate#bin:evidence-gate` | `evidence-gate.static-cli` | `static-cli-input` | `evidence-gate.cli-adversarial.v1`<br>`evidence-gate.cli-malformed.v1`<br>`evidence-gate.cli-negative.v1`<br>`evidence-gate.cli-positive.v1` | adversarial, malformed, negative, positive |
| `@proofrail/evidence-gate#bin:evidence-gate` | `evidence-gate.static-cli` | `static-cli-output` | `evidence-gate.cli-output-adversarial.v1`<br>`evidence-gate.cli-output-malformed.v1`<br>`evidence-gate.cli-output-negative.v1`<br>`evidence-gate.cli-output-positive.v1` | adversarial, malformed, negative, positive |
| `@proofrail/evidence-gate#bin:evidence-gate-github` | `evidence-gate.github-arguments` | `github-cli-arguments` | `evidence-gate.github-arguments-adversarial.v1`<br>`evidence-gate.github-arguments-malformed.v1`<br>`evidence-gate.github-arguments-negative.v1`<br>`evidence-gate.github-arguments-positive.v1` | adversarial, malformed, negative, positive |
| `@proofrail/evidence-gate#bin:proofrail-release` | `release.arguments` | `release-cli-arguments` | `evidence-gate.release-arguments-adversarial.v1`<br>`evidence-gate.release-arguments-malformed.v1`<br>`evidence-gate.release-arguments-negative.v1`<br>`evidence-gate.release-arguments-positive.v1` | adversarial, malformed, negative, positive |
| `@proofrail/evidence-gate#export:.` | `evidence-gate.packet` | `static-evidence-packet` | `evidence-gate.packet-adversarial.v1`<br>`evidence-gate.packet-malformed.v1`<br>`evidence-gate.packet-negative.v1`<br>`evidence-gate.packet-positive.v1` | adversarial, malformed, negative, positive |
| `@proofrail/evidence-gate#export:./github` | `evidence-gate.github-normalize` | `github-readonly-normalization` | `evidence-gate.github-normalize-adversarial.v1`<br>`evidence-gate.github-normalize-malformed.v1`<br>`evidence-gate.github-normalize-negative.v1`<br>`evidence-gate.github-normalize-positive.v1` | adversarial, malformed, negative, positive |
| `@proofrail/evidence-gate#export:./release` | `release.arguments` | `release-cli-arguments` | `evidence-gate.release-arguments-adversarial.v1`<br>`evidence-gate.release-arguments-malformed.v1`<br>`evidence-gate.release-arguments-negative.v1`<br>`evidence-gate.release-arguments-positive.v1` | adversarial, malformed, negative, positive |
| `@proofrail/kernel#export:.` | `kernel.evaluate` | `deterministic-kernel-boundary` | `kernel.forbidden-authority.v1`<br>`kernel.malformed-input.v1`<br>`kernel.positive.v1`<br>`kernel.unknown-field.v1` | adversarial, malformed, negative, positive |
| `@proofrail/release-orchestrator#export:.` | `release-orchestrator.offline` | `offline-release-orchestration` | `release-orchestrator.offline-golden.v1`<br>`release-orchestrator.snapshot-adversarial.v1`<br>`release-orchestrator.snapshot-malformed.v1`<br>`release-orchestrator.snapshot-negative.v1` | adversarial, malformed, negative, positive |
| `@proofrail/static-evaluator#bin:static-evaluate` | `static-evaluator.cli` | `static-evaluator-cli` | `static-evaluator.invalid-utf8.v1`<br>`static-evaluator.negative.v1`<br>`static-evaluator.oversize.v1`<br>`static-evaluator.positive.v1` | adversarial, malformed, negative, positive |
| `@proofrail/static-evaluator#bin:static-evaluate` | `static-evaluator.cli` | `static-evaluator-cli-output` | `static-evaluator.output-adversarial.v1`<br>`static-evaluator.output-malformed.v1`<br>`static-evaluator.output-negative.v1`<br>`static-evaluator.output-positive.v1` | adversarial, malformed, negative, positive |
| `@proofrail/trusted-config#export:.` | `trusted-config.load` | `trusted-configuration-loader` | `trusted-config.hash-mismatch.v1`<br>`trusted-config.loader-malformed.v1`<br>`trusted-config.loader-positive.v1`<br>`trusted-config.path-traversal-adversarial.v1` | adversarial, malformed, negative, positive |
| `@proofrail/trusted-config#export:.` | `trusted-config.strict-json` | `strict-json-parser` | `trusted-config.strict-json-adversarial.v1`<br>`trusted-config.strict-json-malformed.v1`<br>`trusted-config.strict-json-negative.v1`<br>`trusted-config.strict-json-positive.v1` | adversarial, malformed, negative, positive |
